  ...
  try {
    ...
    var dgeni = new Dgeni([require('../config/')
      .config(function (readFilesProcessor, writeFilesProcessor) {
        ...
        readFilesProcessor.sourceFiles = [{include: 'js/modules/**/src/**/*.js', basePath: 'js/modules'}, {include: 'js/modules/config/*.js', basePath: 'js/modules'}, {include: 'docs/content/**/*.ngdoc', basePath: 'docs/content'}];
